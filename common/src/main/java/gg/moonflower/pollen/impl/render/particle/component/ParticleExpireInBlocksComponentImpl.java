...
@ApiStatus.Internal
public class ParticleExpireInBlocksComponentImpl extends BedrockParticleComponentImpl implements BedrockParticleTickComponent {

    private static final Logger LOGGER = LogUtils.getLogger();
    private final Block[] blocks;

    public ParticleExpireInBlocksComponentImpl(BedrockParticle particle, ParticleExpireInBlocksComponent data) {
        super(particle);
